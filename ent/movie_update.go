...
func (mu *MovieUpdate) SetRated(f float32) *MovieUpdate {
	mu.mutation.ResetRated()
	mu.mutation.SetRated(f)
	return mu
}

// AddRated adds f to the "rated" field.
func (mu *MovieUpdate) AddRated(f float32) *MovieUpdate {
	mu.mutation.AddRated(f)
	return mu
}

// SetRealeaseDate sets the "realease_date" field.
func (mu *MovieUpdate) SetRealeaseDate(t time.Time) *MovieUpdate {
	mu.mutation.SetRealeaseDate(t)
	return mu
}

// SetNillableRealeaseDate sets the "realease_date" field if the given value is not nil.
func (mu *MovieUpdate) SetNillableRealeaseDate(t *time.Time) *MovieUpdate {
	if t != nil {
		mu.SetRealeaseDate(*t)
	}
	return mu
}
...
func (mu *MovieUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := mu.mutation.AddedRated(); ok {
	...
	if value, ok := mu.mutation.RealeaseDate(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
...
// SetRated sets the "rated" field.
func (muo *MovieUpdateOne) SetRated(f float32) *MovieUpdateOne {
	muo.mutation.ResetRated()
	muo.mutation.SetRated(f)
	return muo
}

// AddRated adds f to the "rated" field.
func (muo *MovieUpdateOne) AddRated(f float32) *MovieUpdateOne {
	muo.mutation.AddRated(f)
	return muo
}

// SetRealeaseDate sets the "realease_date" field.
func (muo *MovieUpdateOne) SetRealeaseDate(t time.Time) *MovieUpdateOne {
	muo.mutation.SetRealeaseDate(t)
	return muo
}

// SetNillableRealeaseDate sets the "realease_date" field if the given value is not nil.
func (muo *MovieUpdateOne) SetNillableRealeaseDate(t *time.Time) *MovieUpdateOne {
	if t != nil {
		muo.SetRealeaseDate(*t)
	}
	return muo
}
...
func (muo *MovieUpdateOne) sqlSave(ctx context.Context) (_node *Movie, err error) {
	...
	if value, ok := muo.mutation.AddedRated(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeFloat32,
			Value:  value,
			Column: movie.FieldRated,
	...
	if value, ok := muo.mutation.RealeaseDate(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
			Column: movie.FieldRealeaseDate,
